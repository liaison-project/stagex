...
uint256 hashGenesisBlock("0xaa34a08c4711541fdd1f695a18a5525c7a9b84a5b6dbf6ee2951a6be56e5863d");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1840000); // Xxxcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 20 * 60; // Xxxcoin: 20 mins
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaa34a08c4711541fdd1f695a18a5525c7a9b84a5b6dbf6ee2951a6be56e5863d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 31/jul/2018 Do you think that is air you are breathing ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1533064660;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1365103;
        ...
        assert(block.hashMerkleRoot == uint256("0x33cbb47176d5fab9ca215cd29a68a2440ade6a3867ad8f3d0da1d32869ba9aee"));
